use hdf5::{types::TypeDescriptor, H5Type, SimpleExtents};
use ndarray::s;

use crate::error::{HDF5Error, NexusDatasetError, NexusNumericError};

use super::{
    super::{
        dataholder_class::{
            NexusClassAppendableDataHolder, NexusClassMutableAppendableDataHolder,
            NexusClassNumericAppendableDataHolder,
        },
        log_value::{DatasetBuilderNumericExt, DatasetNumericExt, NumericVector},
        traits::{
            NexusAppendableDataHolder, NexusDataHolderVectorMutable, NexusDatasetDef,
            NexusH5InstanceCreatableDataHolder, NexusNumericAppendableDataHolder,
            NexusSearchableDataHolder,
        },
    },
    NexusDataset,
};

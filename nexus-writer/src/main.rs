...
//  To run run-simulator
// cargo run --bin run-simulator -- --broker localhost:19092 --topic Controls --run-name Test run-start --instrument-name SuperMuSR
...
// To run nexus-writer
// cargo run --bin nexus-writer -- --broker localhost:19092 --consumer-group nexus-writer --control-topic Control --event-topic Events --file-name output/Saves
#[derive(Debug, Parser)]

            ...
            .find(|log| log.get_name() == message.source_name())
        {
            ...
            let mut log = match message.value_type() {
                supermusr_streaming_types::ecs_f144_logdata_generated::Value::Byte => 
                    NexusGroup::<Log>::new(message.source_name(), &(self.settings, TypeDescriptor::Integer(hdf5::types::IntSize::U1))),
                supermusr_streaming_types::ecs_f144_logdata_generated::Value::Short => 
                    NexusGroup::<Log>::new(message.source_name(), &(self.settings, TypeDescriptor::Integer(hdf5::types::IntSize::U2))),
                supermusr_streaming_types::ecs_f144_logdata_generated::Value::Int => 
                    NexusGroup::<Log>::new(message.source_name(), &(self.settings, TypeDescriptor::Integer(hdf5::types::IntSize::U4))),
                supermusr_streaming_types::ecs_f144_logdata_generated::Value::Long => 
                    NexusGroup::<Log>::new(message.source_name(), &(self.settings, TypeDescriptor::Integer(hdf5::types::IntSize::U8))),
                supermusr_streaming_types::ecs_f144_logdata_generated::Value::UByte => 
                    NexusGroup::<Log>::new(message.source_name(), &(self.settings, TypeDescriptor::Unsigned(hdf5::types::IntSize::U1))),
                supermusr_streaming_types::ecs_f144_logdata_generated::Value::UShort => 
                    NexusGroup::<Log>::new(message.source_name(), &(self.settings, TypeDescriptor::Unsigned(hdf5::types::IntSize::U2))),
                supermusr_streaming_types::ecs_f144_logdata_generated::Value::UInt => 
                    NexusGroup::<Log>::new(message.source_name(), &(self.settings, TypeDescriptor::Unsigned(hdf5::types::IntSize::U4))),
                supermusr_streaming_types::ecs_f144_logdata_generated::Value::ULong => 
                    NexusGroup::<Log>::new(message.source_name(), &(self.settings, TypeDescriptor::Unsigned(hdf5::types::IntSize::U8))),
                supermusr_streaming_types::ecs_f144_logdata_generated::Value::Float => 
                    NexusGroup::<Log>::new(message.source_name(), &(self.settings, TypeDescriptor::Float(hdf5::types::FloatSize::U4))),
                supermusr_streaming_types::ecs_f144_logdata_generated::Value::Double => 
                    NexusGroup::<Log>::new(message.source_name(), &(self.settings, TypeDescriptor::Float(hdf5::types::FloatSize::U8))),
            };
            log.push_message(message, location)?;
            self.logs.push(log);
        }
